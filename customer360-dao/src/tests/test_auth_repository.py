"""Unit tests for leo_customer360_dao.repositories.auth_repository.AuthRepository.
...
from leo_customer360_dao.repositories.auth_repository import AuthRepository, _validated_schema
...
class SchemaValidationTests(unittest.TestCase):
    ...
    def test_repository_init_raises_on_unsafe_configured_schema(self):
        session = FakeDBSession()
        with mock.patch("leo_customer360_dao.repositories.auth_repository.settings.db_schema", "bad;schema"):
            with self.assertRaises(ValueError):
