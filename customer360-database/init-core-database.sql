...
INSERT INTO customer360.cdp_profile_attributes (
    ...
    ('persona_name', 'persona_name', 'Persona Name', 'Human-readable, non-PII label for segmentation/marketing and semantic search (e.g. "Gen Z Shopper"). Required whenever is_hashed = TRUE; auto-generated by customer360-backend/identity_resolution when real PII is hashed.', 'MARKETING', 'cdp_master_profiles', 'TEXT', 'all', FALSE, 'ACTIVE', FALSE, NULL, NULL, NULL, FALSE, NULL, NULL, 'label', NULL, NULL, NULL, 345),
    ...
    ('persona_embedding', NULL, 'Persona Embedding', 'LLM-generated centroid embedding used for semantic search / lookalike modeling. Lives on the SHARED cdp_persona_archetypes row (joined via cdp_master_profiles.current_persona_id -> cdp_customer_personas.persona_archetype_id), not on cdp_master_profiles directly.', 'MARKETING', 'cdp_persona_archetypes', 'VECTOR', 'all', FALSE, 'ACTIVE', FALSE, NULL, NULL, NULL, FALSE, NULL, NULL, 'metadata', NULL, NULL, NULL, 350),
...
-- actually read by customer360-backend/identity_resolution today:
