# Ad Request Cache Utilities to support the Customer 360 Promotions API.
# TODO 
...
# all CacheConfig settings should be loaded from the PromotionsSettings class in core/config.py, and should be configurable via environment variables or .env file.
# update customer360-promotions/.env.example for the new cache configuration settings, and provide documentation for each setting.