...
def check_postgres_available() -> bool:
    ...
    try:
        ...
        conn = psycopg2.connect(
            host=os.getenv("c360_PROMOTION_DB_HOST", "localhost"),
            port=os.getenv("c360_PROMOTION_DB_PORT", "5432"),
            user=os.getenv("c360_PROMOTION_DB_USER", "postgres"),
            password=os.getenv("c360_PROMOTION_DB_PASSWORD", "postgres"),
            dbname=os.getenv("c360_PROMOTION_DB_NAME", "customer360"),
            connect_timeout=2,
        )
