"""Placeholder Dagster job for the Personalization service (customer360-backend/personalization).
...
see the personalization-model metadata columns already reserved in
...
(`../workspace.yaml`) already has a `personalization` code location ready for that
...
PLACEHOLDER_SLEEP_SECONDS = int(os.environ.get("PERSONALIZATION_PLACEHOLDER_SLEEP_SECONDS", "2"))
