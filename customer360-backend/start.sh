...
# loading every customer360-backend service via workspace.yaml -- LOCAL DEV ONLY.
# Docker deployments use the same unified customer360-backend image. See README.md
...
# source of truth for CIR_*/DB_*/etc settings instead of a customer360-backend-
