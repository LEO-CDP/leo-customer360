...
(function (C360) {
  ...
  var STATIC_HTML = ["tabs", "settings-modal", "profiles-list", "placeholder", "segments-list", "attributes-list", "data-source-list", "analytics", "campaign-dashboard", "persona-list"];
